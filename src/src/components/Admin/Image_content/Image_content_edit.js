...
const Image_content_edit = () => {
  ...
  if (answer_array[2] == "localhost:3000") {
    ...
    var url = "https://prameshsilks.com/backend/index.php/api/image_content_added";
  }
  ...
  if (answer_array[2] == "localhost:3000") {
    ...
    var urls = `https://prameshsilks.com/backend/index.php/api/all_image_content_get?iContentId=${iContentId}`;
  }

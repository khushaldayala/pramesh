...
const Stories_edit = () => {
  ...
  const handleSubmit = (event) => {
    ...
    if (answer_array[2] == "localhost:3000") {
      ...
      var url = "https://prameshsilks.com/backend/index.php/api/stories_added";
    }
  ...
  if (answer_array[2] == "localhost:3000") {
    ...
    var urls = `https://prameshsilks.com/backend/index.php/api/all_stories?iStoriesId=${iStoriesId}`;
  }
  useEffect(() => {
    axios
      .get(urls)

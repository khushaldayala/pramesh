...
const Color_Edit = () => {
  ...
  function Editcolor() {
    ...
    if (answer_array[2] == "localhost:3000") {
      ...
      var url = `https://prameshsilks.com/backend/index.php/api/color_add?iColorId=${iColorId}`;
    }
  ...
  if (answer_array[2] == "localhost:3000") {
    ...
    var url = `https://prameshsilks.com/backend/index.php/api/all_color_get?iColorId=${iColorId}`;
  }

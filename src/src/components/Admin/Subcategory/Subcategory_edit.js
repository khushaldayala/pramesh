...
const Subcategory_edit = () => {
    ...
    function addcategory() 
    {
        ...
        if (answer_array[2] == 'localhost:3000') {
            ...
            var url = 'https://prameshsilks.com/backend/index.php/api/subcategory_add';
        }
    ...
    {
        var urls = `https://prameshsilks.com/backend/index.php/api/all_subcategory_get?iSubcategoryId=${iSubcategoryId}`;
    }
    useEffect(()=>{
        axios.get(urls)
        .then(res=>{

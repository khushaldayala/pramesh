...
const Footer = () => {
    ...
    function validateEmail() {
        ...
        if (pattern.test(emailText)) {
            if (answer_array[2] == 'localhost:3000') {
                ...
                var email_verify = 'https://prameshsilks.com/backend/index.php/api/email_varify_news_letter';
            }
    ...
    const newsletter = () => {
        ...
        if (answer_array[2] == "localhost:3000") {
            ...
            var news_letter = `https://prameshsilks.com/backend/index.php/api/newsLetter`;
        }
        ...
        <>
            <footer className="contact">
                ...
                <div className="mb-5">
                    ...
                    <p>+919978944074 | pramesh.orders@gmail.com</p>
                </div>

                <div className="mb-5">
                    <h1>STORE TIMINGS </h1>
                    <p> MON - SUN | 11:00 AM - 8:00 PM (IST)</p>
                    <p>Shangrila Arcade, 109, above Dangee Dums, Ahmedabad, Gujarat 380015, India</p>

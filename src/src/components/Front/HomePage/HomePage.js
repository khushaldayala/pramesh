...
const HomePage = () => {
    ...
    if (answer_array[2] == 'localhost:3000') {
        ...
        var urls = `https://prameshsilks.com/backend/index.php/api/banner`;
        var minibanner = `https://prameshsilks.com/backend/index.php/api/mini_banner`;
        var FirstImage = `https://prameshsilks.com/backend/index.php/api/first_image`;
        var Secondimage = `https://prameshsilks.com/backend/index.php/api/second_image`;
        var Thirdimage = `https://prameshsilks.com/backend/index.php/api/third_image`;
        var homepage_producturl = `https://prameshsilks.com/backend/index.php/api/homepage_product`;
    }

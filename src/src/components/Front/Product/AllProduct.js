...
const AllProduct = () => {
    ...
    if (answer_array[2] == "localhost:3000") {
        ...
        var Color = `https://prameshsilks.com/backend/index.php/api/get_category`;
    }
...
// ************************************************WISH LIST ADDED DATA END************************************************
    ...
    const ClickColorFilter = async (e) => {
        ...
        if (answer_array[2] == "localhost:3000") {
            ...
            var color_url = `https://prameshsilks.com/backend/index.php/api/product_listing?Filter=${Filter}`;
        }

...
const Checkout = () => {
  ...
  const PaymentsuccessProccess = () => {
    ...
    if (answer_array[2] == "localhost:3000") {
      ...
      var url =
        "https://prameshsilks.com/backend/index.php/api/paymentsuccessproccess";
    }
  ...
  const emailverify = (e) => {
    ...
    if (pattern.test(emailText)) {
      if (answer_array[2] == "localhost:3000") {
        ...
        var email_verify =
          "https://prameshsilks.com/backend/index.php/api/email_varify";
      }
  ...
  const Checkoutdatasave = (event) => {
    ...
    if ((error == false && EmailDone == 0) || EmailDone == 2) {
      ...
      if (answer_array[2] == "localhost:3000") {
        ...
        var url = "https://prameshsilks.com/backend/index.php/api/checkoutdata";
      }
      const dataa = axios
        .post(url, data)
        .then((res) => {

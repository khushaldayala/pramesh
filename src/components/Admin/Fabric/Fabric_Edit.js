...
const Fabric_Edit = () => {
  ...
  function Editcolor() {
    ...
    if (answer_array[2] == "localhost:3000") {
      ...
      var url = `https://prameshsilks.com/backend/index.php/api/fabric_add?iFabricId=${iFabricId}`;
    }
  ...
  if (answer_array[2] == "localhost:3000") {
    ...
    var url = `https://prameshsilks.com/backend/index.php/api/all_fabric_get?iFabricId=${iFabricId}`;
  }

...
class Variants extends React.Component {
    ...
    async componentDidMount() 
    {
        ...
        {
            var variant_url = `https://prameshsilks.com/backend/index.php/api/get_variants`;
        }
    ...
    option_create(iVariantsId)
    {
        ...
        if (answer_array[2] == 'localhost:3000') 
        {
            ...
            var urls = `https://prameshsilks.com/backend/index.php/api/get_variants_wise_option?iVariantsId=${iVariantsId}`;
        }
    ...
    delete = (idx) => () => 
    {
        ...
        if (answer_array[2] == 'localhost:3000') {
            ...
            var del = 'https://prameshsilks.com/backend/index.php/api/product_variyant_delete';
        }
    ...
    submitdata = (e) =>{
        ...
        if (answer_array[2] == 'localhost:3000') {
            ...
            var url = 'https://prameshsilks.com/backend/index.php/api/variants_added';
        }

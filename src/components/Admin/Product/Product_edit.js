...
const Product_edit = () => {
  ...
  const handleSubmit = (event) => {
    ...
    if (answer_array[2] == "localhost:3000") {
      ...
      var url = "https://prameshsilks.com/backend/index.php/api/product_added";
    }
  ...
  async function category_change(e) {
    ...
    if (answer_array[2] == "localhost:3000") {
      ...
      var urls = `https://prameshsilks.com/backend/index.php/api/get_category?iCategoryId=${iCategoryId}`;
    }
  ...
  if (answer_array[2] == "localhost:3000") {
    ...
    var urlp = `https://prameshsilks.com/backend/index.php/api/all_product?iProductId=${iProductId}`;
  }
  useEffect(() => {
    axios
      .get(urlp)
  ...
  if (answer_array[2] == "localhost:3000") {
    ...
    var urls = `https://prameshsilks.com/backend/index.php/api/get_category`;
  }

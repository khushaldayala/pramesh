...
const Product_image = () => {
    ...
    if (answer_array[2] == "localhost:3000") {
        ...
        var url                 = "https://prameshsilks.com/backend/index.php/api/product_image_add";
        var urlimage            = "https://prameshsilks.com/backend/index.php/api/product_image_delete";
        var urls                = `https://prameshsilks.com/backend/index.php/api/all_product?iProductId=${iProductId}`;

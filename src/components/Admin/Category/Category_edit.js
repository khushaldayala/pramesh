...
const Category_edit = () => {
  ...
  function addcategory() {
    ...
    if (answer_array[2] == "localhost:3000") {
      ...
      var url = "https://prameshsilks.com/backend/index.php/api/category_add";
    }
  ...
  if (answer_array[2] == "localhost:3000") {
    ...
    var urls = `https://prameshsilks.com/backend/index.php/api/all_category_get?iCategoryId=${iCategoryId}`;
  }

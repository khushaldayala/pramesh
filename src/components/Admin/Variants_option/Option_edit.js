...
const Option_edit = () => {
  ...
  if (answer_array[2] == "localhost:3000") {
    ...
    var urls = `https://prameshsilks.com/backend/index.php/api/all_option_get?iOptionId=${iOptionId}`;
    var url = "https://prameshsilks.com/backend/index.php/api/option_add";
  }

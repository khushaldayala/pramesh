...
const Variants_edit = () => {
  ...
  if (answer_array[2] == "localhost:3000") {
    ...
    var urls = `https://prameshsilks.com/backend/index.php/api/all_variants_get?iVariantId=${iVariantId}`;
    var url = "https://prameshsilks.com/backend/index.php/api/variants_add";
  }

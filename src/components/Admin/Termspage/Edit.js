...
function Edit() {
  ...
  function termssavedata() {
    ...
    if (Aboutus) {
      ...
      if (answer_array[2] == "localhost:3000") {
        ...
        var url =
          "https://prameshsilks.com/backend/index.php/api/terms_page_save_data";
      }
      const dataa = axios
        .post(url, fd)
        .then((res) => {
  ...
  if (answer_array[2] == "localhost:3000") {
    ...
    var urls = `https://prameshsilks.com/backend/index.php/api/all_terms_get?iTermsId=${iTermsId}`;
  }

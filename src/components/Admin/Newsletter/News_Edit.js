...
const News_Edit = () => {
  ...
  function Editcolor() {
    ...
    if (answer_array[2] == "localhost:3000") {
      ...
      var url = `https://prameshsilks.com/backend/index.php/api/News_letter_add?iNewsLetterId=${iNewsLetterId}`;
    }
  ...
  if (answer_array[2] == "localhost:3000") {
    ...
    var url = `https://prameshsilks.com/backend/index.php/api/all_news_letter_get?iNewsLetterId=${iNewsLetterId}`;
  }

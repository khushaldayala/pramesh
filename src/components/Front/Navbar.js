...
const Navbar = () => {
  ...
  const AllSearchData = (e) => {
    ...
    if (answer_array[2] == "localhost:3000") {
      ...
      var search_url = `https://prameshsilks.com/backend/index.php/api/search`;
    }
  ...
  if (answer_array[2] == "localhost:3000") {
    ...
    var header = `https://prameshsilks.com/backend/index.php/api/header`;
    var srories = `https://prameshsilks.com/backend/index.php/api/stories`;
    var url = `https://prameshsilks.com/backend/index.php/api/main_product_listing`;
    var cartdatasave = `https://prameshsilks.com/backend/index.php/api/addtocartdataget?cookie=${cookie}@@${iUserId}`;
    var terms =
      "https://prameshsilks.com/backend/index.php/api/all_terms_condition_get";
  }
  ...
  const SubcategortClick = async (e) => {
    ...
    if (answer_array[2] == "localhost:3000") {
      ...
      var product_listing = `https://prameshsilks.com/backend/index.php/api/product_listing?Filter=${Filter}`;
    }

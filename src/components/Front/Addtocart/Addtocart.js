...
const Addtocart = () => {
  ...
  const AddtocartProduct = async () => {
    if (answer_array[2] == "localhost:3000") {
      ...
      var product_listing = `https://prameshsilks.com/backend/index.php/api/single_product_get?iProductId=${iProductId}@@${vPrice}`;
      var cartdatasave = `https://prameshsilks.com/backend/index.php/api/addtocartdataget?cookie=${cookie}@@${iUserId}`;
    }
  ...
  const sizechange = (e) => {
    ...
    if (answer_array[2] == "localhost:3000") {
      ...
      var product_url = "https://prameshsilks.com/backend/index.php/api/product_size_wise_data_get";
    }
    ...
    if (Size || sizedata == '0') {
      if (Addqty != '0') {
        if (answer_array[2] == "localhost:3000") {
          ...
          var addtocart = "https://prameshsilks.com/backend/index.php/api/addtocart";
        }
        const dataa = axios
          .post(addtocart, fd)
          .then((res) => {
  ...
  const wishlistAdded = (e) => {
    ...
    if (iProductId != '0') {
      if (answer_array[2] == "localhost:3000") {
        ...
        var wishlist_url = "https://prameshsilks.com/backend/index.php/api/wishlishadded";
      }
      const dataa = axios
  ...
  const Remove_addtocart = (e) => {
    ...
    if (answer_array[2] == "localhost:3000") {
      ...
      var remove_product = `https://prameshsilks.com/backend/index.php/api/addtocartdelete`;
    }
            ...
            return (
              <>
                ...
                <div className="col-xl-7 col-lg-7 rightcart">
                  ...
                  <input type="hidden" id="vQty" value={Totalquntity} />
                  ...
                  <div className="qty mt-5">
                    ...
                    {
                      Totalquntity===0 ? <span className="red">Product not available</span> : ''
                    }

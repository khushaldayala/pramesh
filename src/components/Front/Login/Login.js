    ...
    {  
        ...
        if (Emaildata == true && Password)
        {
            if (answer_array[2] == 'localhost:3000') {
                ...
                var register = 'https://prameshsilks.com/backend/index.php/api/login_user';
            }
    ...
    const ResetPassword = () =>
    {
        ...
        if (Emaildata == true && ResetEmail) {
            ...
            if (answer_array[2] == 'localhost:3000') {
                ...
                var resetpass = 'https://prameshsilks.com/backend/index.php/api/reset_password_email_check';
            }
            const fd = new FormData();
